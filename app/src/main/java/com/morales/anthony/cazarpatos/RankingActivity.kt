...
class RankingActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        jugadores.add(Player("Anthony.Morales",10))
        jugadores.add(Player("Jugador2",6))
        jugadores.add(Player("Jugador3",3))
        jugadores.add(Player("Jugador4",9))
        jugadores.add(Player("Jugador5",1))
        jugadores.add(Player("Jugador6",2))
        jugadores.add(Player("Jugador7",3))
        jugadores.add(Player("Jugador8",5))
        jugadores.add(Player("Jugador9",7))
        jugadores.add(Player("Jugador10",8))
